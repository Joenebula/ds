...
`references/variants.md` carries **140 components and 284 variants**, each with the
...
`dist/components.css` carries **140 components and 284 variants** as real classes,
generated from the Figma extracts, plus **11 more that ship as shape only** — Figma binds
