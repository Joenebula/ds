...
`references/variants.md` carries **138 components and 282 variants**, each with the
...
`dist/components.css` carries **138 components and 282 variants** as real classes,
...
138 of the 172 Figma components are in the stylesheet. The remaining 34 are listed in
