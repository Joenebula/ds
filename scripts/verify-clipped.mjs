#!/usr/bin/env node
// RENAMED FROM verify-layout.mjs IN THE 2026-09-12 MERGE, because two branches independently
// wrote a file of that name and they ask DIFFERENT questions. This one asks whether anything is
// CUT OFF or escaping its container; the other asks whether things that should line up do.
// Keeping one and dropping the other would have lost a real axis silently, so both are kept and
// this one took a name that says what it measures.
